    ...
    execute: async (client, interaction, args) => {
        ...
        con.query({
            ...
            async function (err, result, fields) {
                ...
                const text = (punishment === "None") ? `Removed Punishment for every member that is detected as Scammer or bad actor!` : `Set ${punishment} as Punishment for every member that was detected to be a Scammer or bad actor!`
